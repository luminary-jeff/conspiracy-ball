...
def main():
    ...
    w("- Not tested: player prop lines, which are the one public source plausibly sharper than RotoWire, and")
    w("  practice-report detail beyond the injury tag.")
    w("")
    w("## Reproduce")
    w("")
    w("```")
    ...
    w("python3 research/weekly.py      # snapshot + refresh + scoreboard, run each week")
    w("```")
